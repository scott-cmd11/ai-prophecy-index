  ...
  predictions: [
    ...
    },
    {
      ...
      references: [
        ...
        { label: "Bloomberg: WH opposes Mythos access expansion (Apr 30)", url: "https://www.bloomberg.com/news/articles/2026-04-30/white-house-opposes-anthropic-plan-for-mythos-access-wsj-says" },
      ],
      implications:
